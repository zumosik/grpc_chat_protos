...
goog.exportSymbol('proto.rooms.Token', null, global);
 ...
 * @constructor
 */
proto.rooms.Token = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rooms.Token, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rooms.Token.displayName = 'proto.rooms.Token';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.rooms.Token.prototype.toObject = function(opt_includeInstance) {
  return proto.rooms.Token.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rooms.Token} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rooms.Token.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rooms.Token}
 */
proto.rooms.Token.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rooms.Token;
  return proto.rooms.Token.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rooms.Token} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rooms.Token}
 */
proto.rooms.Token.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rooms.Token.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rooms.Token.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rooms.Token} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rooms.Token.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.rooms.Token.prototype.getToken = function() {
 ...
 * @return {string}
 */
proto.rooms.Token.prototype.getToken_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.rooms.Token.prototype.getToken_asU8 = function() {
 ...
 * @return {!proto.rooms.Token} returns this
 */
proto.rooms.Token.prototype.setToken = function(value) {
